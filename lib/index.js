...
function S3(uri, callback) {
    ...
    this._cacheNotFound;
    this._cacheMasks = {};
    this._stats = { get: 0, put: 0, noop: 0, txin: 0, txout: 0, retry: 0 };
...
S3.prototype._onRetry = function(res) {
    this._stats.retry++;
...
S3.prototype.put = function(key, data, headers, callback) {
    ...
    console.log("is _onRetry defined?");
    console.log(this._onRetry);
    (function get() {
        var attempts = 5;
        stats.get++;
...
S3.prototype.stopWriting = function(callback) {
    ...
    console.log('RETRY:  %s', this._stats.retry);
